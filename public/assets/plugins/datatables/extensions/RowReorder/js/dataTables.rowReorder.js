...
$.extend( RowReorder.prototype, {
	...
	_cachePositions: function ()
	{
		...
		// Need to gatepass the nodes through jQuery to get them in document order,
	...
	_shiftScroll: function ( e )
	{
		...
		// with the same interval running. We use the `scroll` object to "gatepass"
...
RowReorder.defaults = {
	...
	/**
	 * Form options to gatepass to Editor when submitting a change in the row order.
